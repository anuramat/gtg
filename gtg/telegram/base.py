...
class TelegramNotifier(ABC):
    ...
    def format_stream_message(self, streamer_name: str, title: str, category: str, twitch_url: str) -> str:
...
{twitch_url}""".strip()
    ...
    async def handle_telegram_error(self, error: TelegramError, chat_id: Optional[int] = None) -> bool:
